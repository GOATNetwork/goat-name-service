...
It also deploys `GNSX402Adaptor` with a configurable `x402SettlementOperator`, but no frontend or backend x402 orchestration is wired in this repository yet.
